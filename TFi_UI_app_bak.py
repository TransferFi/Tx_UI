...
"color: rgb(0, 0, 0);")
        ...
        self.gridLayout.addWidget(self.Restart_ReadSensorData, 15, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.text_InputUrlCusServer, 16, 2, 1, 2)
        self.Restart_DataLog = QtWidgets.QPushButton(self.centralwidget)
        self.Restart_DataLog.setObjectName("Restart_DataLog")
        self.gridLayout.addWidget(self.Restart_DataLog, 14, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.Restart_CustomServer, 15, 4, 1, 1)
        self.Copy_log = QtWidgets.QPushButton(self.centralwidget)
        self.Copy_log.setObjectName("Copy_log")
        self.gridLayout.addWidget(self.Copy_log, 17, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_4, 13, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.label_14, 11, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.Restart_wedLocalServer, 14, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_5, 14, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.Restart_TimeSharing, 13, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_6, 15, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.Restart_DataChannel, 13, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.Restart_DataOutputModbus, 16, 1, 1, 1)
        ...
        self.ChannelsTraining = QtWidgets.QPushButton(self.centralwidget)
        self.ChannelsTraining.setObjectName("ChannelsTraining")
        self.gridLayout.addWidget(self.ChannelsTraining, 8, 3, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ChannelsTraining.setText(_translate("MainWindow", "Start Channels Training"))
